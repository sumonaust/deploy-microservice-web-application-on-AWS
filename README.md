# Deploying Microservice web Application on AWS
Frontend Deployment, Backend Deployment, Security Implementation, Monitoring and Scaling, Backup and Disaster Recovery.
...
## Deploying Microservice web Application on AWS EKS
